...
func InitParser(controllerClass, ignore string, basePath string) *parser.Parser {
...
type Params struct {
	ApiPackage, BasePackage, MainApiFile, OutputFormat, OutputSpec, ControllerClass, Ignore, VendoringPath string
	ContentsTable, Models                                                                                  bool
}

func Run(params Params) error {
	parser := InitParser(params.ControllerClass, params.Ignore, params.BasePackage)
